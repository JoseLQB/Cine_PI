...
<body class="admin">
    ...
    if ($fetch == 2) {
        $men = '<div id="msg_error" class="alert alert-danger" role="alert">Introduce todos los datos</div>';
    } else if ($fetch == 1) {
        $men = '<div id="msg_ok" class="alert alert-success" role="alert"><center>Nuevo título insertado</center></div>';
    }
    ?>
    <div class="container">
        <?php include_once("../inc/navAdmin.php") ?>
        <div class="row d-flex justify-content-around mt-5">
            <div class="card col-md-6 col-md-offset-6"><br>
        <?php echo $men; ?>
            <a href="buscador/buscar.php" target="_blank" class=" text-center">
